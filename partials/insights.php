<div fs-cmsfilter-element="scroll-anchor" class="main-wrapper">
          ...
          <div class="title-page_wrapper">
            <div class="title-page_title">
              ...
              <div class="circle-chek_component">
                <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6356c11143d2fe247c1f8719_text-circle-vf.svg" loading="lazy" alt="" class="circle-chek_text-circle-img"/>
                <img src="https://cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/634ed0dafc477ada004efe8e_check-circle%20(3).svg" loading="lazy" alt="" class="circle-chek_img-check"/>
              </div>
            </div>
            <div class="title-page_info">
              <p>
                Stay up-to-date with the latest in cybersecurity, digital marketing, SEO, conversion rate optimization, web design practices, AI in business, and more with our informative blog
                <br/>
              </p>
            </div>
          </div>
            ...
            <div data-animation="default" data-collapse="tiny" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="recent-work_nav-filter w-nav">
              <div class="recent-work_nav-title">
                ...
                <div class="recent-work_nav-btn w-nav-button">
                  <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/640a15ddfe03d12c708639cf_icon-filter.svg" loading="lazy" alt="" class="recent-work_nav-icon"/>
                </div>
              </div>
            </div>
          </div>
  ...
  <div id="contact" class="start-project_component">
        ...
        <div class="padding-section-large">
          <div class="start-project_wrapper">
            <div class="title-section_component is-start-project">
              ...
              <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c13bc67ea35707ca3618_pinter-center-left.webp" loading="lazy" alt="" class="start-project_pointer-left"/>
              <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/63502e202b328f0db4bc2bb9_pointer-blue-medium.webp" loading="lazy" alt="" class="start-project_pointer-right"/>
            </div>
            <div class="form-wrapper">
              <div class="start-project_form-wrapper w-form">
                <form method="get" data-form="multistep" name="email-form" data-name="Email Form" data-enter="true" id="email-form" class="start-project_form" data-wf-page-id="65b4453c9e0f05c6674b733e" data-wf-element-id="1bb21479-b3fd-6123-9361-dece65ec47e6">
                  <div class="form-step-wrapper">
                      ...
                      <div class="step-wrapper">
                        ...
                        <div class="form-checkbox-wrapper">
                          <label class="w-checkbox checkbox-field">
                            <img loading="lazy" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/657899eb61cc8bbd33b3dd8e_icon-form-04.svg" alt="" class="icon-1x1-large"/>
                            ...
                            <input id="Generate-leads" type="checkbox" name="Generate-leads" data-name="Generate leads" style="opacity:0;position:absolute;z-index:-1"/>
                          ...
                          <label class="w-checkbox checkbox-field">
                            ...
                            <input id="Making-sales" type="checkbox" name="Making-sales" data-name="Making sales" style="opacity:0;position:absolute;z-index:-1"/>
                            <img loading="lazy" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/657899ebff6b4e0e4aeb252b_icon-form-02.svg" alt="" class="icon-1x1-large"/>
                          ...
                          <label class="w-checkbox checkbox-field">
                            ...
                            <input id="Improve-your-ROI" type="checkbox" name="Improve-your-ROI" data-name="Improve your ROI" style="opacity:0;position:absolute;z-index:-1"/>
                            <img loading="lazy" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/657899ec9c912d3cded4e352_icon-form-03.svg" alt="" class="icon-1x1-large"/>
                          ...
                          <label class="w-checkbox checkbox-field">
                            ...
                            <input id="Other" type="checkbox" name="Other" data-name="Other" style="opacity:0;position:absolute;z-index:-1"/>
                            <img loading="lazy" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/657899eb7abedc68ea6602cd_icon-form-01.svg" alt="" class="icon-1x1-large"/>
                      ...
                      <div class="step-wrapper">
                        ...
                        <div data-radio-delay="250" data-radio-skip="true" class="form-checkbox-wrapper is-3-col">
                          <label class="checkbox-field w-radio">
                            <div class="w-form-formradioinput w-form-formradioinput--inputType-custom check-box w-radio-input">
                            </div>
                            <input id="USA" type="radio" name="Where-is-your-business-located" data-name="Where is your business located?" style="opacity:0;position:absolute;z-index:-1" value="USA"/>
                            <img loading="lazy" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/657899ec1734bdf716b1bbcb_icon-flag-03.svg" alt="" class="icon-1x1-large"/>
                            <div class="form-field-icon is-test">
                              <div class="form-field-letter">
                                A
                              </div>
                          ...
                          <label class="checkbox-field w-radio">
                            ...
                            <input id="LATAM" type="radio" name="Where-is-your-business-located" data-name="Where is your business located?" style="opacity:0;position:absolute;z-index:-1" value="LATAM"/>
                            <img loading="lazy" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6578a0220fc74ed333466bab_icon-latam.svg" alt="" class="icon-1x1-large"/>
                            <div class="form-field-icon is-test">
                              <div class="form-field-letter">
                                B
                              </div>
                          ...
                          <label class="checkbox-field w-radio">
                            ...
                            <input id="OTHER-2" type="radio" name="Where-is-your-business-located" data-name="Where is your business located?" style="opacity:0;position:absolute;z-index:-1" value="OTHER"/>
                            <img loading="lazy" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/657899ecb25fe4f94366890f_icon-flag-01.svg" alt="" class="icon-1x1-large"/>
                            <div class="form-field-icon is-test">
                              <div class="form-field-letter">
                                C
                              </div>
                    ...
                    <div data-form="step" class="form-step-item">
                      <div class="step-wrapper">
                        ...
                        <div class="form-input-wrapper">
                          <div class="form-description">
                            EX: I work at a Miami real estate agency, aiming to boost marketing for properties ranging from $500k to $5m.
                          </div>
                        </div>
                        <div class="form-field-group">
                          ...
                          <div class="form-input-wrapper">
                            <textarea id="Describe-your-business-needs-in-1-3-sentences" name="Describe-your-business-needs-in-1-3-sentences" maxlength="5000" data-name="Describe your business needs in 1-3 sentences." placeholder=" Type here... What you offer, target market, your average price" class="form-input is-text-area w-input">
                            </textarea>
                          </div>
                        </div>
                        <div class="form-button-wrapper">
                    ...
                    <div data-form="step" class="form-step-item">
                      <div class="step-wrapper">
                        ...
                        <div class="form-field-group">
                          <div class="form-input-wrapper">
                            <input class="form-input w-input" maxlength="256" name="Name" data-name="Name" placeholder="First name..." type="text" id="Name-4" required=""/>
                          </div>
                          <div class="form-input-wrapper">
                            <input class="form-input w-input" maxlength="256" name="Email" data-name="Email" placeholder="mail@domain.com" type="email" id="Email-5" required=""/>
                          </div>
                        </div>
                        <div class="form-button-wrapper">
                          <a data-form="next-btn" href="#" class="form-button w-button">
                    ...
                    <div data-form="step" class="form-step-item">
                      <div class="step-wrapper">
                        <div class="step-content-only">
                          ...
                          <div class="form-button-wrapper">
                            <input type="submit" data-wait="Please wait..." data-form="submit-btn" class="form-button w-button" value="Send it away!"/>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="start-project_form-success w-form-done">
                  <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352ce11c9635f2f09cc594a_s.gif" loading="lazy" alt="" class="start-project_form-success-img"/>
          ...
          <div class="start-project_contact">
            ...
            <div class="start-project_contact-btn">
              <a href="/cdn-cgi/l/email-protection#90f8f5fcfcffd0f1e0e2ffe3bef7fcfff2f1fcafe3e5f2faf5f3e4adc3e4f1e2e4b5a2a0f1b5a2a0f3fffee6f5e2e3f1e4f9fffe" class="button is-secondary is-large w-inline-block">
    ...
    <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c93735e7540ef4112f89_bg-light-blue-vf.webp" loading="lazy" sizes="(max-width: 1533px) 100vw, 1533px" srcset="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c93735e7540ef4112f89_bg-light-blue-vf-p-500.webp 500w, <?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c93735e7540ef4112f89_bg-light-blue-vf-p-800.webp 800w, <?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c93735e7540ef4112f89_bg-light-blue-vf.webp 1533w" alt="" class="start-project_light-img"/>
    <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c981fd0a0301dc9c6abc_bg-star-project-grid.webp" loading="lazy" sizes="50vw" srcset="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c981fd0a0301dc9c6abc_bg-star-project-grid-p-500.png 500w, <?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c981fd0a0301dc9c6abc_bg-star-project-grid-p-800.png 800w, <?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/6352c981fd0a0301dc9c6abc_bg-star-project-grid.webp 994w" alt="" class="start-project_grid-right"/>
  </div>
</div>
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js">
</script>
<script src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js" type="text/javascript" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous">
</script>
<script src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/js/webflow.schunk.b7cad701f94860c2.js" type="text/javascript">
</script>
<script src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/js/webflow.schunk.712216aa265cd9af.js" type="text/javascript">
</script>
<script src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/js/webflow.9da2dfb5.369f27a81ce1a348.js" type="text/javascript">
</script>
<script src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.jsdelivr.net/gh/videsigns/webflow-tools@latest/multi-step.js">
</script>
<script src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/src/assets/cdn.jsdelivr.net/gh/studio-freight/lenis@0.2.28/bundled/lenis.js">
</script>
<script>

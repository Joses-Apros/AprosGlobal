<?php
// TODO: pegar aqui el body de apros.webflow2/insights.html
      ...
      <div class="padding-section-medium">
        <div class="title-page_wrapper">
          <div class="title-page_title">
            <h1 class="heading-style-h1-big">Digital <span class="text-color-degrade-light">Insights</span></h1>
          ...
          <div class="title-page_info">
            <p>Stay up-to-date with the latest in cybersecurity, digital marketing, SEO, conversion rate optimization, web design practices, AI in business, and more with our informative blog<br></p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="recent-work_nav-title">
              ...
              <nav role="navigation" class="recent-work_nav-menu w-nav-menu">
                <div class="recent-work_form w-form">
                  <form id="email-form-2" name="email-form-2" data-name="Email Form 2" method="get" fs-cmsfilter-element="filters" class="recent-work_form-wrapper" data-wf-page-id="65b4453c9e0f05c6674b733e" data-wf-element-id="31b1934b-527a-746f-a120-9a9664498579"><input type="submit" data-wait="Please wait..." class="button hide-all w-button" value="Submit">
        ...
        <div class="collection-list-wrapper w-dyn-list">
          <div fs-cmsfilter-element="list" fs-cmsload-element="list" fs-cmsload-mode="infinite" fs-cmsload-duration="800" fs-cmsload-stagger="200" role="list" class="recent-work_main-grid w-dyn-items">
            <div role="listitem" class="recent-work_item-cl w-dyn-item">
              <a data-w-id="f60ce262-174f-1e3a-4caf-a21ba9cddc0b" href="#" class="blog_item w-inline-block">
          ...
          <div role="navigation" aria-label="List" class="w-pagination-wrapper recent-work_pagination">
            ...
            <a href="#" aria-label="Next Page" class="w-pagination-next button">
              <div class="w-inline-block">Next</div><img src="images/icon-btn.svg" loading="lazy" alt="" class="icon-1x1-small">
            </a>
          </div>
        </div>
      </div>
...
<?php
$insights_markup = ob_get_clean();
$insights_markup = preg_replace_callback(

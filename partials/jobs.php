          ...
          <div class="position_wrapper">
            <div class="title-page_wrapper is-job">
              <div class="title-page_title is-center">
                ...
                <div class="circle-chek_component">
                  <img
                    src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/64c93303b43eb37ff079285e_frame-dark-blue.svg"
                    loading="lazy" alt="" class="circle-chek_text-circle-img" />
                  <img
                    src="https://cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/634ed0dafc477ada004efe8e_check-circle%20(3).svg"
                    loading="lazy" alt="" class="circle-chek_img-check" />
            ...
            <div class="position_main w-form">
              <form id="email-form" name="email-form" data-name="Email Form" method="get" fs-cmsfilter-element="filters"
                          ...
                          <div data-w-id="74e09dd0-7b7e-7c1c-0ea6-315a3d17173b" class="position_acordeon-trigger">
                            <div class="position_acordeon-title">
                              ...
                              <div class="position_acordeon-detalles">
                                <div class="position_acordeon-detalles-item">
                                  <img
                            ...
                            <img
                              src="https://cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/64c937c3712a42ef592551eb_icon-trigger%20(2).svg"
                              loading="lazy"
                              style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0deg) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0deg) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0deg) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0deg) skew(0, 0)"
                              alt="" class="position_acordeon-icon" />
                          </div>
                          <div style="height:0px" class="position_acordeon-content">
                            <div class="position_acordeon-info">
                              <div class="jobs_richt-text w-richtext">
                                <p>
                                  We take pride in delivering flawless web experiences that exceed client expectations.
                                  As a QA Specialist, you&#x27;ll play a pivotal role in ensuring the accuracy and
                                  quality of our web projects by meticulously testing features, comparing designs with
                                  coded websites, and upholding our commitment to excellence.
                                </p>
                                <h3>
                                  <strong>
                                    Responsibilities:
                                ...
                                <ul role="list">
                                  <li>
                                    Conduct thorough testing of web features and functionalities to identify defects and
                                    inconsistencies.
                                  </li>
                                  <li>
                                    Perform visual checks to ensure the final website matches the original design
                                    specifications.
                                  </li>
                                  <li>
                                    Collaborate with development and design teams to resolve issues and discrepancies.
                                  </li>
                                  <li>
                                    Document test results, report bugs, and track their resolution.
                                  </li>
                                  <li>
                                    Contribute to continuous improvement by suggesting process enhancements and best
                                    practices.
                                  </li>
                                </ul>
                                <h3>
                                ...
                                <ul role="list">
                                  <li>
                                    Proven experience as a QA Specialist or in a similar role within the web development
                                    industry.
                                  </li>
                                  <li>
                                    Strong attention to detail and a keen eye for design and functional accuracy.
                                  </li>
                                  <li>
                                    Familiarity with testing methodologies, defect tracking, and quality assurance
                                    processes.
                                  </li>
                                  <li>
                                ...
                                <ul role="list">
                                  ...
                                  <li>
                                    Opportunity to shape the quality assurance process of a forward-thinking company.
                                  </li>
                                  <li>
                              ...
                              <a href="https://docs.google.com/forms/d/e/1FAIpQLSdmOe9CGMxF2xe0ab9AEWmRlERL2dAsdp2PFK2y_oOV4c4G8g/viewform"
                        ...
                        <div class="position_acordeon-item">
                          ...
                          <div style="height:0px" class="position_acordeon-content">
                            <div class="position_acordeon-info">
                              <div class="jobs_richt-text w-richtext">
                                <p>
                                  We are at the forefront of optimizing web experiences through robust server
                                  infrastructure. As a Server Infrastructure Specialist, you&#x27;ll play a critical
                                  role in designing, securing, and maintaining hosting environments that ensure optimal
                                  website performance and resource utilization.
                                </p>
                                <h3>
                                  <strong>
                                    Responsibilities:
                                ...
                                <ul role="list">
                                  <li>
                                    Collaborate with development teams to design and implement scalable and secure
                                    server infrastructures.
                                  </li>
                                  <li>
                                    Optimize hosting environments for maximum website speed, reliability, and resource
                                    efficiency.
                                  </li>
                                  <li>
                                    Implement and manage security measures to safeguard data and prevent unauthorized
                                    access.
                                  </li>
                                  <li>
                                    Monitor server performance and proactively address issues to maintain seamless
                                    operations.
                                  </li>
                                  <li>
                                    Stay up-to-date with industry trends and best practices in server infrastructure
                                    optimization.
                                  </li>
                                </ul>
                                <h3>
                                ...
                                <ul role="list">
                                  <li>
                                    Proven experience as a Server Infrastructure Specialist or in a similar role within
                                    the technology industry.
                                  </li>
                                  <li>
                                    In-depth knowledge of server architecture, hosting technologies, and optimization
                                    strategies.
                                  </li>
                                  <li>
                                    Strong expertise in security protocols, firewall configuration, and vulnerability
                                    assessment.
                                  </li>
                                  <li>
                                ...
                                <ul role="list">
                                  ...
                                  <li>
                                    Opportunity to shape the server infrastructure strategy of a forward-thinking
                                    company.
                                  </li>
                                  <li>
                                    Collaborative and innovative work environment.
                        ...
                        <div class="position_acordeon-item">
                          ...
                          <div style="height:0px" class="position_acordeon-content">
                            <div class="position_acordeon-info">
                              <div class="jobs_richt-text w-richtext">
                                <p>
                                  We believe that our greatest asset is our people. As a Talent Manager, you will play a
                                  vital role in nurturing our team&#x27;s growth, fostering a dynamic work culture, and
                                  ensuring that our exceptional talent is empowered to reach their full potential.
                                </p>
                                <h3>
                                  <strong>
                                    Responsibilities:
                                ...
                                <ul role="list">
                                  <li>
                                    Develop and execute strategies for attracting, recruiting, and retaining top-tier
                                    talent.
                                  </li>
                                  <li>
                                    Create and manage professional development plans to help team members succeed and
                                    advance in their roles.
                                  </li>
                                  <li>
                                    Oversee performance reviews and feedback mechanisms to enhance individual and team
                                    performance.
                                  </li>
                                  <li>
                                    Collaborate with department heads to align talent acquisition with business
                                    objectives.
                                  </li>
                                  <li>
                                    Champion diversity and inclusion initiatives to build a diverse and inclusive work
                                    environment.
                                  </li>
                                </ul>
                                <h3>
                                ...
                                <ul role="list">
                                  <li>
                                    Proven experience as a Talent Manager or in a similar role within the technology or
                                    creative industry.
                                  </li>
                                  <li>
                                    Strong interpersonal skills to build relationships and connect with diverse team
                                    members.
                                  </li>
                                  <li>
                                    Exceptional communication skills to effectively address employee needs and provide
                                    guidance.
                                  </li>
                                  <li>
                                    Strategic mindset and a commitment to cultivating a culture of continuous learning.
                                  </li>
                                </ul>
                                <h3>
                                  <strong>
                                ...
                                <ul role="list">
                                  ...
                                  <li>
                                    Opportunity to shape the growth and culture of a dynamic company.
                                  </li>
                                  <li>
                          ...
                          <div style="height:0px" class="position_acordeon-content">
                            <div class="position_acordeon-info">
                              <div class="jobs_richt-text w-richtext">
                                ...
                                <p>
                                  As the Assistant to the Sales Manager, you will play a vital role in supporting our
                                  sales team in generating and managing leads. You will work closely with the Sales
                                  Manager to optimize our lead generation process, follow up on inquiries, and assist
                                  with maintaining customer relationships. This is an excellent opportunity to be part
                                  of a collaborative and driven team, contributing to the growth and success of our web
                                  development company.
                                </p>
                                <p>
                                  ‍
                                ...
                                <ul role="list">
                                  <li>
                                    Assist the Sales Manager in managing and nurturing leads generated through our
                                    advertising campaigns on a daily basis.
                                  </li>
                                  <li>
                                    Follow up on leads promptly, respond to inquiries, and provide relevant information
                                    to potential clients.
                                  </li>
                                  <li>
                                    Schedule appointments, meetings, and demos for the Sales Manager with prospective
                                    clients.
                                  </li>
                                  <li>
                                    Maintain and update the customer relationship management (CRM) system with accurate
                                    and up-to-date lead information.
                                  </li>
                                  <li>
                                    Collaborate with the marketing team to develop sales collateral, presentations, and
                                    other materials.
                                  </li>
                                  <li>
                                    Conduct market research to identify potential clients and stay informed about
                                    industry trends.
                                  </li>
                                  <li>
                                    Provide administrative support to the Sales Manager, including managing email
                                    correspondence, preparing reports, and organizing sales-related documentation.
                                  </li>
                                  <li>
                                    Assist in preparing proposals, contracts, and other sales documents as needed.
                                  </li>
                                  <li>
                                    Coordinate with the project management team to ensure a smooth transition from lead
                                    generation to project initiation.
                                  </li>
                                </ul>
                                <p>
                                  ‍
                                ...
                                <ul role="list">
                                  ...
                                  <li>
                                    Familiarity with the web development industry and basic understanding of website
                                    design and digital marketing concepts.
                                  </li>
                                  <li>
                                    Excellent communication skills, both written and verbal, with strong interpersonal
                                    abilities.
                                  </li>
                                  <li>
                                    Exceptional organizational and multitasking skills, with the ability to prioritize
                                    tasks effectively.
                                  </li>
                                  <li>
                                    Proficiency in using CRM systems, project management tools, and MS Office Suite.
                                  </li>
                                  <li>
                                    Proactive and self-motivated mindset, with the ability to work independently and as
                                    part of a team.
                                  </li>
                                  <li>
                        ...
                        <div class="position_acordeon-item">
                          ...
                          <div style="height:0px" class="position_acordeon-content">
                            <div class="position_acordeon-info">
                              <div class="jobs_richt-text w-richtext">
                                <p>
                                  As a development intern, you&#x27;ll have the unique opportunity to learn from
                                  seasoned professionals, contribute to real-world projects, and gain valuable hands-on
                                ...
                                <ul role="list">
                                  <li>
                                    Collaborate with our development team to create and maintain web applications.
                                  </li>
                                  <li>
                                    Assist in coding, testing, and debugging projects under the guidance of senior
                                    developers.
                                  </li>
                                  <li>
                                    Learn and apply best practices for clean and efficient code.
                                  </li>
                                </ul>
                                <h3>
                                  <strong>
                                ...
                                <ul role="list">
                                  ...
                                  <li>
                                    Excellent communication skills and a willingness to work in a collaborative
                                    environment.
                                  </li>
                                </ul>
                                <h3>
                                ...
                                <ul role="list">
                                  ...
                                  <li>
                                    Exposure to various stages of project development.
                                  </li>
                                  <li>
                                    Opportunity to build a portfolio with real-world projects.
                                  </li>
                                  <li>
                                    Flexible hours to accommodate your learning schedule.
                                  </li>
                                </ul>
                                <p>
                                  ‍
                        ...
                        <div class="position_acordeon-item">
                          ...
                          <div style="height:0px" class="position_acordeon-content">
                            <div class="position_acordeon-info">
                              <div class="jobs_richt-text w-richtext">
                                <p>
                                  As an Account Executive, you will be a pivotal link between our clients and our team,
                                  working collaboratively to identify their unique website needs and ensuring their
                                  digital success.
                                </p>
                                <h3>
                                  <strong>
                                ...
                                <ul role="list">
                                  <li>
                                    Engage with clients to understand their business objectives and website
                                    requirements.
                                  </li>
                                  <li>
                                    Collaborate closely with our development and design teams to tailor solutions that
                                    align with client goals.
                                  </li>
                                  <li>
                                    Oversee the ongoing Tech Support stream, ensuring clients&#x27; websites are
                                    up-to-date with new content, features, and optimizations.
                                  </li>
                                  <li>
                                    Foster strong, long-lasting client relationships by providing exceptional service
                                    and support.
                                  </li>
                                  <li>
                                    Present proposals, articulate technical concepts, and provide clients with a clear
                                    roadmap for their digital projects.
                                  </li>
                                </ul>
                                <h3>
                                  <strong>
                                ...
                                <ul role="list">
                                  <li>
                                    Proven experience as an Account Executive or in a client-facing role within the
                                    technology or web development industry.
                                  </li>
                                  <li>
                                    Excellent communication skills to effectively bridge the gap between clients and
                                    technical teams.
                                  </li>
                                  <li>
                                    Ability to understand clients&#x27; needs and translate them into actionable
                                    requirements.
                                  </li>
                                  <li>
                                    Problem-solving acumen and a strategic mindset to anticipate client needs.
                                  </li>
                                </ul>
                                <h3>
                                  <strong>
                    ...
                    <div class="position_acordeon-trigger">
                      <div class="position_acordeon-title">
                        ...
                        <div class="position_acordeon-detalles">
                          <div class="position_acordeon-detalles-item">
                            <img
                              src="https://cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/64c93872981a55e20b05a588_marcador%20(1).svg"
                              loading="lazy" alt="" />
                            <div class="text-size-small">
                              Colombia
                            </div>
                      ...
                      <img
                        src="https://cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/64c937c3712a42ef592551eb_icon-trigger%20(2).svg"
                        loading="lazy" alt="" class="position_acordeon-icon" />
                    </div>
                    <div class="position_acordeon-content">
                      <div class="position_acordeon-info">
                        <div class="jobs_richt-text w-richtext">
                          ...
                          <p>
                            A rich text element can be used with static or dynamic content. For static content, just
                            drop it into any page and begin editing. For dynamic content, add a rich text field to any
                            collection and then connect a rich text element to that field in the settings panel. Voila!
                          </p>
                          <p>
                            <sub>
                              qwdqwdqwd
                          ...
                          <p>
                            ...
                            after a class is added to the rich text element using the &quot;When inside of&quot; nested
                            selector system.
                          </p>
                        </div>
                      </div>
                ...
                <input type="submit" data-wait="Please wait..." class="hide-all w-button" value="Submit" />
              </form>
      ...
      <div class="container-large">
        <div class="padding-section-small">
          <div class="project_cta-wrapper is-work">
            <div class="project_cta-info is-work">
              <img
                src="https://cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/634ed0dafc477ada004efe8e_check-circle%20(3).svg"
                loading="lazy" alt="" class="blog_cta-icon is-work" />
              <div class="project_cta-content">
                ...
                <p>
                  Send us your resume and tell us why you wouldlike to be a friend of Apros
                </p>
              </div>
            </div>
...
<script
  src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/src/assets/cdn.prod.website-files.com/634ecebdb4ffd446e52e6f19/js/webflow.87bc73bb.52c48133a5448821.js"
  type="text/javascript">
  </script>
<script
...
<script
  src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/src/assets/cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.0/jquery.waypoints.min.js">
  </script>
<script>
